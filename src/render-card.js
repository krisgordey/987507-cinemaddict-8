export default (cardData) => `<article class="film-card ${cardData.showControls !== true ? `film-card--no-controls` : ``}">
          ...
          ${cardData.showControls ? `<p class="film-card__description">${cardData.description}</p>` : ``}
          <button class="film-card__comments">13 comments</button>

          ${cardData.showControls === true ? `<form class="film-card__controls">
